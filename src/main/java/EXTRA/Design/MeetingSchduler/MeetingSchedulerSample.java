package EXTRA.Design.MeetingSchduler;
...
import static EXTRA.Design.MeetingSchduler.MeetingSchedulerSample.TimeSlot.createNewSlot;

/**
 * Created by abhishek.gupt on 27/12/17.
 */
public class MeetingSchedulerSample {

    private Map<TimeSlot, Meeting> meetings = new HashMap<>();

    public static void main(String[] args)
    {
        MeetingSchedulerSample scheduler = new MeetingSchedulerSample();
